...
emoji_list = {
    "HEART": "\033[31m  __  __  \n /  \\/  \\ \n \\      / \n  \\    /  \n   \\__/   \033[0m",
    "SMILE": "\033[38;2;57;255;20m:)\033[0m",
    "SAD": "\033[31m:(\033[0m",
    "WINK": "\033[38;2;57;255;20m;)\033[0m",
    "WAVING": " ___ \n/^-^\\ \n\\___/ \n _|_/°\n| |\n| |\n / \\ \n/   \\ ",
    "MOON": "  ______ \n /  ___ \\ \n|   \\  \\ |\n| __/  / |\n| \\___/  |\n \\______/",
    "TEXPY": "   ____   \n  /___/__ \n  / /\\/ / \n /_/_/\\_\\ ",
}
...
with open(get_pat("test.txt")) as data:
    # with open(get_pat("RatespielNEW.txt")) as data:
    code = data.readlines()
